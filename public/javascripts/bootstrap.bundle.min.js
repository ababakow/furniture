...
!(function(t, e) {
	...
	const P = {
			...
			trigger(t, e, i) {
				...
				return (
					a && l.preventDefault(), r && t.dispatchEvent(l), l.defaultPrevented && s && s.preventDefault(), l
				);
			}
		},
		M = new Map(),
			...
			for (const n of Object.keys(e)) {
				const s = e[n],
					...
					a = o(r)
						...
						: null == (i = r)
							? `${i}`
							: Object.prototype.toString.call(i).match(/\s([a-z]+)/i)[1].toLowerCase();
				...
				: Ee(
						(function(t) {
							var e,
								...
								l = -n.scrollTop;
							return (
								'rtl' === Gt(s || i).direction && (a += Vt(i.clientWidth, s ? s.clientWidth : 0) - o),
			...
			n &&
				((e = this._resolvePossibleFunction(e))
					? o(e)
						...
						: this._config.html ? (n.innerHTML = this._maybeSanitize(e)) : (n.textContent = e)
					: n.remove());
		}
		_maybeSanitize(t) {
		...
		_setListeners() {
			...
			for (const e of t)
				if ('click' === e)
					...
					const t =
							e === tn ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
						i =
							e === tn
